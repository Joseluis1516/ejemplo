...
<head>
    ...
    <title>Cabecera Trabajador</title>
</head>
...
<body style="margin: 0">
    ...
    <nav class="navbar bg-light">
        ...
        <div class="container-fluid" id="cabecera">
            ...
            <a value="inicio" href="principal_trabajador.php" style="text-decoration: none; color:#000;"><button class="submit">Inicio</button></a>
            <a value="inicio" href="lista_solicitudes_terminadas.php" style="text-decoration: none; color:#000;"><button class="submit">Lista de Solicitud Terminadas</button></a>
            <a value="inicio" href="notificaciones.php" style="text-decoration: none; color:#000;"><button class="submit">Alertas</button></a>
