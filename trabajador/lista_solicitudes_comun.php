...
WHERE s.estatus=1 AND u.nom_usuario ='$usuario2' ");
            ...
            <tbody>
                <?php while ($row = mysqli_fetch_array($eje)) { ?>
                    ...
                    <tr>
                        ...
                        <td class="styled-table td "><a href="../img/evidencias/ echo $row['imagen']?>" target="_blank"> <img src="../img/evidencias/<?php echo $row['imagen'] ?>" alt="" width="200px"></a></td>
                        ...
                        <td>
                            <div style="display: flex; justify-content: space-around;">
                                <button onclick="editar(<?php echo $row['pk_solicitud'] ?>)" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
...
<script language="javascript">
    ...
    function editar() {
        terminar = confirm('¿Desea editar la solicitu?')
        if (terminar) {
            location.href = "../inserciones/editar_solicitud.php?pk_solicitud=" + pk_solicitud
        }
    }
</script>