...
FROM solicitud s, espacios e, categorias_atencion ca, usuario u, persona p, espacios es, edificios ed 
WHERE s.fk_espacios=e.pk_espacios
AND s.fk_categoria_atencion=ca.pk_categoria_atencion 
AND s.fk_usuario=u.pk_usuario
AND u.fk_persona=p.pk_persona
AND s.fk_espacios=es.pk_espacios
AND es.fk_edificios=ed.pk_edificios 
AND s.estatus=0");
...
<head>
    ...
    <title>Solicitudes Terminadas</title>
